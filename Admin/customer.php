<?php 
  ...
  if(isset($_GET['type']) && $_GET['type']!=='' && isset($_GET['id']) && $_GET['id']>0){
    ...
    if($type=='delete'){
      ...
      $con->query("update customer set status='$status' where id='$id'");
 ...
 ?>         
          <h1 class="card-title ml10">Customer</h1>
          <div class="card">
            <div class="card-body">
              
              <a href="addcustomer.php"><label class="badge badge-info">Add Customer</label></a>
              <div class="row">
                <div class="col-12">
                    ...
                    $i=1;
                        while($row=$res->fetch_assoc()){  ?>
                            <tr>
                                ...
                                <td>
                                    <a href="addcustomer.php?id=<?php echo $row['id'] ?>"><label class="badge badge-info cursor-hand">Edit</label></a>
                                    &nbsp;
                                    <?php 
                                    if($row['status']==1){?>
